"""Surreal-Memory vs Vanilla Vector Search -- Qualitative Comparison.
...
Surreal-Memory returns context -- related memories, connections, chains.
...
async def main() -> None:
    ...
    print(f"{BOLD}  Surreal-Memory vs Vector Search -- Side-by-Side Comparison{RESET}")
    print(f"{BOLD}{'=' * 80}{RESET}\n")
    ...
    print()
    print(f"  {GREEN}Surreal-Memory{RESET}:   Returns activated context -- memories + connections.")
