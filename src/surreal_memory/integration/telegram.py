...
Bot token: SURREAL_MEMORY_TELEGRAM_BOT_TOKEN env var (never stored in config file).
...
def get_bot_token() -> str | None:
    ...
    return os.environ.get("SURREAL_MEMORY_TELEGRAM_BOT_TOKEN")
...
async def get_telegram_status() -> TelegramStatus:
    ...
    if not token:
        return TelegramStatus(
            ...
            error="SURREAL_MEMORY_TELEGRAM_BOT_TOKEN not set",
        )
