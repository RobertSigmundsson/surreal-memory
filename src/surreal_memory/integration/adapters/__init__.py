...
def _lazy_load_adapter(name: str) -> type | None:
    ...
    if name == "chromadb":
        try:
            from surreal_memory.integration.adapters.chromadb_adapter import ChromaDBAdapter
            ...
            msg = (
                ...
                "Install with: pip install surreal-memory[chromadb]"
            )
            raise ValueError(msg) from e

    if name == "mem0":
        try:
            from surreal_memory.integration.adapters.mem0_adapter import Mem0Adapter
            ...
            msg = (
                ...
                "Install with: pip install surreal-memory[mem0]"
            )
            raise ValueError(msg) from e

    if name == "mem0_self_hosted":
        try:
            from surreal_memory.integration.adapters.mem0_adapter import Mem0SelfHostedAdapter
    ...
    if name == "awf":
        try:
            from surreal_memory.integration.adapters.awf_adapter import AWFAdapter

            register_adapter("awf", AWFAdapter)
            return AWFAdapter
        except ImportError as e:
            msg = "AWF adapter requires 'aiohttp' package. Install with: pip install surreal-memory"
            raise ValueError(msg) from e

    if name == "cognee":
        try:
            from surreal_memory.integration.adapters.cognee_adapter import CogneeAdapter
            ...
            msg = (
                ...
                "Install with: pip install surreal-memory[cognee]"
            )
            raise ValueError(msg) from e

    if name == "graphiti":
        try:
            from surreal_memory.integration.adapters.graphiti_adapter import GraphitiAdapter
            ...
            msg = (
                ...
                "Install with: pip install surreal-memory[graphiti]"
            )
            raise ValueError(msg) from e

    if name == "llamaindex":
        try:
            from surreal_memory.integration.adapters.llamaindex_adapter import LlamaIndexAdapter
            ...
            msg = (
                ...
                "Install with: pip install surreal-memory[llamaindex]"
            )
            raise ValueError(msg) from e
