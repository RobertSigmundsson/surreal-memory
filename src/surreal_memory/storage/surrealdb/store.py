...
def _row_to_fiber(row: dict[str, Any]) -> Fiber:
    ...
    NOTE (found while adding `find_fibers_by_embedding`, NOT fixed here): unlike `_row_to_neuron`, this never folds
    ...
    is out of scope for that retriever (which only reads `fiber.anchor_neuron_id`, never `fiber.id`,
