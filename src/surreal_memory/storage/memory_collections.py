...
class InMemoryCollectionsMixin:
    ...
    async def find_fibers_by_embedding(
        ...
        cosine scale as `find_neurons_by_embedding` (N2 fix, smem-recall-leksyka-fibry-reranker,
        2026-09-12). `NeuralStorage` NEVER leaves this a stub here: `InMemoryStorage` is the test
