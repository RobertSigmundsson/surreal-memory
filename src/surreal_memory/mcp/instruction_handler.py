...
class InstructionHandler:
    ...
    async def _refine(self, args: dict[str, Any]) -> dict[str, Any]:
        ...
        if mem_type_val not in ("instruction", "workflow"):
            return {
                "error": f"smem_refine only supports instruction/workflow memories, got '{mem_type_val}'"
            }
    ...
    async def _report_outcome(self, args: dict[str, Any]) -> dict[str, Any]:
        ...
        if mem_type_val not in ("instruction", "workflow"):
            return {
                "error": f"smem_report_outcome only supports instruction/workflow memories, got '{mem_type_val}'"
            }
