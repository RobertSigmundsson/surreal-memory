    ...
    async def _budget(self, args: dict[str, Any]) -> dict[str, Any]:
        ...
        if action == "estimate":
                ...
                recommendations.append(
                    {
                        ...
                        "suggestion": "Consider running smem_consolidate to compress this fiber's content into a summary.",
                    }
                )
            ...
            return {
                ...
                "tip": "Run smem_consolidate with strategy='mature' to auto-summarize old fibers.",
            }
