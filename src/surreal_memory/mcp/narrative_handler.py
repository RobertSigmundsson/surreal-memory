...
class NarrativeHandler:
    """Mixin providing smem_narrative tool handler for MCPServer."""
    ...
    async def _narrative(self, args: dict[str, Any]) -> dict[str, Any]:
        """Handle smem_narrative tool calls.
    ...
    async def _narrative_timeline(
        ...
        from surreal_memory.engine.narrative import generate_timeline_narrative
    ...
    async def _narrative_topic(
        ...
        from surreal_memory.engine.narrative import generate_topic_narrative
    ...
    async def _narrative_causal(
        ...
        from surreal_memory.engine.narrative import generate_causal_narrative
