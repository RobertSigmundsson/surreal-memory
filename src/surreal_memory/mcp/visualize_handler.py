"""MCP handler mixin for memory visualization — smem_visualize tool."""
...
class VisualizeHandler:
    """Mixin providing smem_visualize tool handler for MCPServer."""
    ...
    async def _visualize(self, args: dict[str, Any]) -> dict[str, Any]:
        """Handle smem_visualize tool calls.
        ...
        try:
            ...
            from surreal_memory.engine.chart_generator import (
                extract_data_points,
                generate_chart,
            )
