...
try:
    from surreal_memory.integration.telegram import TelegramError as _TelegramError
except ImportError:
...
class TelegramHandler:
    ...
    async def _telegram_backup(self, args: dict[str, Any]) -> dict[str, Any]:
        """Handle smem_telegram_backup tool call."""
        try:
            ...
            if not token:
                return {
                    "error": "SURREAL_MEMORY_TELEGRAM_BOT_TOKEN environment variable not set.",
                }
