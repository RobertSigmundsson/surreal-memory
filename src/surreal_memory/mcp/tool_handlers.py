...
from surreal_memory.engine.retrieval import DepthLevel, ReflexPipeline  # noqa: F401

# Domain handler mixins
from surreal_memory.mcp.budget_handler import BudgetHandler
...
from surreal_memory.mcp.tier_handler import TierHandler

# Re-export shared utilities for backward compatibility.
# Many handlers and tests import these from tool_handlers.
from surreal_memory.mcp.tool_handler_utils import (  # noqa: F401
...
class ToolHandler(
    ...
    a subset of the smem_* tool implementations. Protocol stubs for
