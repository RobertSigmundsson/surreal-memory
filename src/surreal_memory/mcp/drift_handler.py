"""MCP handler for semantic drift detection tool (smem_drift)."""
...
class DriftHandler:
    """Mixin providing the smem_drift tool handler for MCPServer."""
    ...
    async def _drift_detect(self, storage: NeuralStorage) -> dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "summary": summary,
                "hint": (
                    "Use smem_drift(action='merge', cluster_id='...') to merge synonyms, "
