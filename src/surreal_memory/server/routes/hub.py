...
# SurrealDB rejects identifiers longer than 128 characters; without this bound a
# charset-valid but over-long brain_id passes validation and the storage error
# surfaces as a 500 instead of a 422 (measured live: 128 passes, 129 fails).
