...
def preset_cmd(
    ...
    Examples:
        smem config preset --list
        smem config preset balanced
        smem config preset max-recall --dry-run
        smem config preset safe-cost
    """
    from surreal_memory.config_presets import (
        apply_preset,
        compute_diff,
        get_preset,
        list_presets,
...
def tier_cmd(
    ...
    Examples:
        smem config tier --show
        smem config tier standard
        smem config tier full
    """
