...
from surreal_memory.engine.merge import ConflictStrategy, MergeReport, merge_snapshots
...
def extract_subgraph(
    ...
    """
    from surreal_memory.core.brain import BrainSnapshot as _BrainSnapshot
