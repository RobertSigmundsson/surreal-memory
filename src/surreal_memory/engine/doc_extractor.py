...
def _extract_pdf(file_path: Path) -> str:
    ...
    try:
        ...
        raise ExtractionError(
            "PDF extraction requires pymupdf4llm. Install with: pip install surreal-memory[extract]"
        )
...
def _extract_docx(file_path: Path) -> str:
    ...
    try:
        ...
        raise ExtractionError(
            "DOCX extraction requires python-docx. Install with: pip install surreal-memory[extract]"
        )
...
def _extract_pptx(file_path: Path) -> str:
    ...
    try:
        ...
        raise ExtractionError(
            "PPTX extraction requires python-pptx. Install with: pip install surreal-memory[extract]"
        )
...
def _extract_html(file_path: Path) -> str:
    ...
    try:
        ...
        raise ExtractionError(
            ...
            "Install with: pip install surreal-memory[extract]"
        )
...
def _extract_xlsx(file_path: Path) -> str:
    ...
    try:
        ...
        raise ExtractionError(
            "XLSX extraction requires openpyxl. Install with: pip install surreal-memory[extract]"
        )
