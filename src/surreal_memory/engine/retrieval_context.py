...
if TYPE_CHECKING:
    ...
    from surreal_memory.engine.token_budget import BudgetAllocation, BudgetConfig
...
async def format_context_budgeted(
    ...
    from surreal_memory.engine.token_budget import TokenCost
    ...
    for fiber in fibers[: cfg.max_fibers_considered]:
        ...
        from surreal_memory.engine.token_budget import estimate_fiber_tokens
