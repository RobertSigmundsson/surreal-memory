...
Stores OpenClaw integration settings in ~/.surrealmemory/openclaw.json.
...
DEFAULT_FUNCTIONS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "enabled": True,
        "timeout_ms": 10000,
        "description": "Recall from Surreal-Memory brain",
    },
    {
        "name": "memory_store",
        "enabled": True,
        "timeout_ms": 10000,
        "description": "Store to Surreal-Memory brain",
    },
    {
        "name": "shell_exec",
        "enabled": False,
...
class OpenClawConfigManager:
    """Load/save OpenClaw config from ~/.surrealmemory/openclaw.json."""

    def __init__(self, config_dir: Path | None = None) -> None:
        if config_dir is None:
            from surreal_memory.unified_config import get_surrealmemory_dir

            config_dir = get_surrealmemory_dir()
