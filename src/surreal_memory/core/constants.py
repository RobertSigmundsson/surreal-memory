...
``engine/compression.py``). Previously the literal appeared in nine files —
a rename in one place silently broke every other check, which is exactly
what this constant exists to make loud (follow-up on the #193 review).
"""
