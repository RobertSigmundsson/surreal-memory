...
The fundamental building blocks of Surreal-Memory.
...
```bash
smem remember "Met Alice at coffee shop. She suggested using JWT for auth."
```
...
```python
from surreal_memory.core import Neuron, NeuronType
...
```python
from surreal_memory.core import Synapse, SynapseType, Direction
