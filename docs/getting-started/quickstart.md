...
!!! tip "3 tools you need"
    Surreal-Memory has 53 tools, but you only need three: **`smem_remember`**, **`smem_recall`**, and **`smem_health`**. The agent handles the other 50 automatically. See [all tools](../guides/mcp-server.md#available-tools).
