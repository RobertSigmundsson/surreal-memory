 ...
 */
import type { Surreal-MemoryMcpClient } from "./mcp-client.js";
type JsonSchema = {
 ...
 */
export declare function createToolsFromMcp(mcp: Surreal-MemoryMcpClient): Promise<ToolDefinition[]>;
/**
 ...
 */
export declare function createFallbackTools(mcp: Surreal-MemoryMcpClient): ToolDefinition[];
/**
 ...
 */
export declare function createCompatibilityTools(mcp: Surreal-MemoryMcpClient): ToolDefinition[];
export {};
