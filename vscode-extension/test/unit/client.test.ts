/**
 * Unit tests for SurrealMemoryClient (HTTP client).
 *
...
import { SurrealMemoryClient, ApiError } from "../../src/server/client";
...
describe("SurrealMemoryClient", () => {
  const BASE_URL = "http://127.0.0.1:8000";
  let client: SurrealMemoryClient;

  beforeEach(() => {
    resetMock();
    client = new SurrealMemoryClient(BASE_URL);
  });
