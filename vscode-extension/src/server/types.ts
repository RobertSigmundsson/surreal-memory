/**
 * TypeScript interfaces mirroring the Surreal-Memory server Pydantic models.
 *
 * Source: surreal_memory/server/models.py
 *         surreal_memory/server/routes/sync.py
 *         surreal_memory/server/app.py (graph endpoint)
 */
