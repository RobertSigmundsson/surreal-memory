/**
 * Typed HTTP client for the Surreal-Memory REST API.
 *
...
/**
 * HTTP client for the Surreal-Memory server.
 *
...
export class SurrealMemoryClient {
  ...
  async importMemories(
    ...
    throw new Error(
      "Import is available via MCP (smem_import) or CLI (smem import). REST endpoint not yet implemented.",
    );
  }
  ...
  async eternal(
    ...
    throw new Error(
      "Eternal context is available via MCP (smem_eternal). REST endpoint not yet implemented.",
    );
  }
  ...
  async recap(
    ...
    throw new Error(
      "Recap is available via MCP (smem_recap). REST endpoint not yet implemented.",
    );
  }
