...
class GroupItem extends vscode.TreeItem {
  constructor(
    ...
    this.contextValue = "surrealmemory.group";
...
class NeuronTreeItem extends vscode.TreeItem {
  constructor(public readonly neuron: NeuronItem) {
    ...
    this.iconPath = new vscode.ThemeIcon(meta.icon);
    this.contextValue = "surrealmemory.neuron";
    ...
    this.command = {
      command: "surrealmemory._recallFromNeuron",
  ...
  registerCommands(context: vscode.ExtensionContext): void {
    ...
    context.subscriptions.push(
      vscode.commands.registerCommand(
        "surrealmemory._recallFromNeuron",
    ...
    // Refresh
    context.subscriptions.push(
      vscode.commands.registerCommand("surrealmemory.refreshMemories", () => {
        this.refresh();
      }),
    );
  }
