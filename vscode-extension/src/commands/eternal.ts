...
export function registerEternalCommands(
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("surrealmemory.recap", async () => {
      if (!server.isRunning()) {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("surrealmemory.recapTopic", async () => {
      if (!server.isRunning()) {
        vscode.window.showWarningMessage(
          "Surreal-Memory server is not running.",
        );
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("surrealmemory.eternalSave", async () => {
      if (!server.isRunning()) {
        vscode.window.showWarningMessage(
          "Surreal-Memory server is not running.",
        );
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("surrealmemory.eternalStatus", async () => {
      if (!server.isRunning()) {
        vscode.window.showWarningMessage(
          "Surreal-Memory server is not running.",
        );
