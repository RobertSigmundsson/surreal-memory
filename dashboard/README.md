# Surreal-Memory Dashboard

React 19 + TypeScript + Vite 7 dashboard for Surreal-Memory.
...
# In another terminal, start the Surreal-Memory server
smem serve
```
...
```bash
npm run build
# Output: ../src/surreal_memory/server/static/dist/
```
