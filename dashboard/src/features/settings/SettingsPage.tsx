...
const FEEDBACK_URLS = [
  "https://github.com/acidkill/surreal-memory/issues/new?template=bug_report.md",
  "https://github.com/acidkill/surreal-memory/issues/new?template=feature_request.md",
  "https://github.com/acidkill/surreal-memory/discussions",
] as const
