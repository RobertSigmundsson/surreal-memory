...
History this replaces. Our own fix for the same symptom (`3f43a844`) hinted the query
...
100% of the rows and forces each one to be decoded, and since the N2 work every fiber row
...
``3f43a844`` is dropped and this test replaces ``test_surrealdb_fiber_lookup_plan.py``.
