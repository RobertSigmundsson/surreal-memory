...
# ---------------------------------------------------------------------------
# MCP tool handler tests (smem_lifecycle)
# ---------------------------------------------------------------------------
...
async def test_lifecycle_status_action() -> None:
    """smem_lifecycle status returns lifecycle distribution."""
...
async def test_lifecycle_freeze_action() -> None:
    """smem_lifecycle freeze sets frozen flag on neuron."""
    from surreal_memory.mcp.tool_handlers import ToolHandler
...
async def test_lifecycle_thaw_action() -> None:
    """smem_lifecycle thaw clears frozen flag on neuron."""
    from surreal_memory.mcp.tool_handlers import ToolHandler
...
async def test_lifecycle_missing_id_error() -> None:
    """smem_lifecycle recover/freeze/thaw without id returns error."""
    from surreal_memory.mcp.tool_handlers import ToolHandler
...
async def test_lifecycle_unknown_action() -> None:
    """smem_lifecycle with unknown action returns error."""
    from surreal_memory.mcp.tool_handlers import ToolHandler
