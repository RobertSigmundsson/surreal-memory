...
class TestSimulatedToolResponses:
    ...
    def test_recall_associative_compact(self) -> None:
        """Simulate smem_recall associative response."""
        result = {
    ...
    def test_recall_exact_compact(self) -> None:
        """Simulate smem_recall exact mode with long content."""
        result = {
            "mode": "exact",
            "memories": [
                {
    ...
    def test_narrative_compact(self) -> None:
        """Simulate smem_narrative response with long markdown."""
        result = {
            "action": "timeline",
