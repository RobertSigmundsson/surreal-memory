...
class TestCheckLatestVersion:
    ...
    async def test_caches_version_info(self) -> None:
        ...
        with patch(
            "surreal_memory.mcp.version_check_handler._fetch_latest_version",
    ...
    async def test_no_update_same_version(self) -> None:
        ...
        with (
            ...
            patch("surreal_memory.mcp.version_check_handler.__version__", "2.4.0"),
        ):
...
class TestGetUpdateHint:
    ...
    @patch("surreal_memory.mcp.version_check_handler._is_editable_install", return_value=False)
...
class TestVersionCheckLoop:
    ...
    async def test_loop_calls_check(self) -> None:
        ...
        with patch(
            "surreal_memory.mcp.version_check_handler.asyncio.sleep",
            fake_sleep,
        ):
            with patch.object(
                handler,
