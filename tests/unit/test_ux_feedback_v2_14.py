...
4. Idle neuron suggestions — smem_suggest with empty prefix
...
class TestIdleNeuronSuggestions:
    """smem_suggest with empty prefix should return idle neurons."""
...
class TestResolvedByDetection:
    ...
    def test_explicit_type_hint(self) -> None:
        ...
        from surreal_memory.engine.conflict_detection import _is_error_memory
