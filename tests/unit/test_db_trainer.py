...
from surreal_memory.engine.db_introspector import (
    ColumnInfo,
    ForeignKeyInfo,
    SchemaSnapshot,
    TableInfo,
)
from surreal_memory.engine.db_knowledge import (
    KnowledgeEntity,
    KnowledgePattern,
    KnowledgeProperty,
...
from surreal_memory.engine.db_trainer import (
    DBTrainer,
    DBTrainingConfig,
    DBTrainingResult,
)
...
class TestHandlerHappyPath:
    ...
    async def test_successful_train_returns_result(self, tmp_path: Path) -> None:
        ...
        with patch("surreal_memory.engine.db_trainer.DBTrainer") as mock_trainer_cls:
