...
from surreal_memory.integration.adapters.mem0_adapter import _parse_mem0_records
from surreal_memory.integration.models import SourceCapability, SourceSystemType
...
class TestMem0SelfHostedAdapter:
    def _make_adapter(self, **kwargs: Any) -> Any:
        from surreal_memory.integration.adapters.mem0_adapter import (
...
class TestAdapterRegistry:
    ...
    def test_lazy_load_self_hosted(self) -> None:
        with patch("surreal_memory.integration.adapters.mem0_adapter.Mem0SelfHostedAdapter"):
            from surreal_memory.integration.adapters import _lazy_load_adapter
