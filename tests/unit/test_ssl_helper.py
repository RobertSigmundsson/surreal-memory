...
from surreal_memory.utils.ssl_helper import get_ssl_context, safe_client_session
...
class TestSafeClientSession:
    ...
    def test_creates_session_with_ssl_connector(self) -> None:
        ...
        with (
            patch("surreal_memory.utils.ssl_helper.get_ssl_context", return_value=fake_ctx),
    ...
    def test_passes_extra_kwargs_to_session(self) -> None:
        with (
            patch("surreal_memory.utils.ssl_helper.get_ssl_context", return_value=True),
