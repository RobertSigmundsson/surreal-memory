...
from surreal_memory.integration.mapper import (
    _RELATION_TYPE_MAP,
    _SOURCE_TYPE_MAP,
    MappingResult,
    RecordMapper,
...
class TestAdapterRegistry:
    def test_list_adapters(self) -> None:
        from surreal_memory.integration.adapters import list_adapters
    ...
    def test_register_and_get_adapter(self) -> None:
        from surreal_memory.integration.adapters import (
            get_adapter,
            register_adapter,
        )
