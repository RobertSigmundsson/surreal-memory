...
from surreal_memory.extraction.structure_detector import (
    ContentFormat,
    StructuredContent,
    StructuredField,
    detect_structure,
...
class TestStructureDetectionStep:
    ...
    async def test_structured_content_adds_metadata(self) -> None:
        ...
        from surreal_memory.engine.pipeline_steps import StructureDetectionStep
...
class TestRetrievalContextStructured:
    ...
    def test_format_if_structured_with_structure(self) -> None:
        from surreal_memory.engine.retrieval_context import _format_if_structured
...
class TestEncoderHasStructureStep:
    ...
    def test_default_pipeline_has_structure_step(self) -> None:
        ...
        from surreal_memory.engine.encoder import build_default_pipeline
