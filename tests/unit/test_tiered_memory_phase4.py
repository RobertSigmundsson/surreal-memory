...
Covers:
1. smem_stats includes tier_distribution
...
class TestStatsTierDistribution:
    """Verify smem_stats response includes tier_distribution."""
...
class TestDashboardTierStatsEndpoint:
    ...
    async def test_tier_stats_endpoint_returns_distribution(self) -> None:
        ...
        from surreal_memory.server.routes.dashboard_api import TierDistribution, get_tier_stats
    ...
    async def test_tier_stats_empty_brain(self) -> None:
        ...
        from surreal_memory.server.routes.dashboard_api import get_tier_stats
