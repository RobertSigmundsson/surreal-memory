...
from surreal_memory.mcp.maintenance_handler import HintSeverity, _evaluate_thresholds
...
class TestRecallExpiryWarnings:
    """Tests for warn_expiry_days on smem_recall."""
    ...
    async def test_recall_with_warn_expiry_days(self, server: MCPServer) -> None:
        ...
        with (
            ...
            result = await server.call_tool("smem_recall", {"query": "test", "warn_expiry_days": 7})
