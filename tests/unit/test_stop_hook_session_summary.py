...
The gate already discards them, so nothing corrupt was ever stored; what the
fallback reliably produced was telemetry noise plus the occasional truncated TODO
