...
from surreal_memory.mcp.sync_handler import (
    _build_hub_url,
    _build_sync_url,
    _handle_http_error,
    _mask_key,
)
from surreal_memory.unified_config import SyncConfig
...
class TestUrlVersioning:
    ...
    def test_cloud_url_gets_v1(self) -> None:
        url = _build_sync_url("https://sync-hub.surrealmemory.dev")
        assert url == "https://sync-hub.surrealmemory.dev/v1/hub/sync"
