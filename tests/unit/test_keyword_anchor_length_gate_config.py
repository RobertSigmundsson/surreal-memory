...
The previous commit moved the length gate (`min_content_len=25`) out of `ReflexPipeline` and onto
...
Written afterwards because that commit shipped without a test of its own: its evidence
was a one-off probe, and nothing in the
